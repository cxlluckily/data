...
/**      
 * @ClassName: userSourceProcessor  
 * @Description: TODO
 * @author yaoshijie  
 * @date 2018年2月1日    
 */
public class UserSourceInitProcessor implements SubDataInitProcessor {

	private final static Logger logger = LoggerFactory.getLogger(UserSourceInitProcessor.class);
