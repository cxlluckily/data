 ...
 * @date 2018年2月7日    
 */
public class PayTypeInitProcessor implements SubDataInitProcessor {

	private final static Logger logger = LoggerFactory.getLogger(PayTypeInitProcessor.class);
